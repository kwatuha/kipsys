...
export function AddPayableInvoiceForm({
  ...
  const vendors = [
    { id: "V-1001", name: "Medical Supplies Ltd" },
    { id: "V-1002", name: "Pharma Distributors" },
    { id: "V-1003", name: "Lab Equipment Co." },
    { id: "V-1004", name: "Office Solutions" },
    { id: "V-1005", name: "Cleaning Services Inc." },
  ]
    ...
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent className="sm:max-w-[800px] max-h-[90vh] overflow-y-auto">
        <DialogHeader>
          ...
          <DialogDescription>Record a new invoice from a vendor.</DialogDescription>
        </DialogHeader>
        <Form {...form}>
